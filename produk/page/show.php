...
if ($action == 'tambah-data' && count($_POST) > 0) {
    ...
    if ($query) {
        echo "<script>alert('Data berhasil ditambah');window.location.href='http://localhost/umkm/produk?manage=" . $link_umkm . "'</script>";
    } else {
    ...
    if (count($_POST) > 0) {
        ...
        if ($query) {
            echo "<script>alert('Data berhasil diupdate'); window.location.href='http://localhost/umkm/produk?manage=" . $link_umkm . "'</script>";
        } else {
        ...
        <div>
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= baseUrl() . '/produk?manage=' . $data_umkm['link_umkm'] ?>">Produk</a></li>
